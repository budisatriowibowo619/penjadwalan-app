        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addJadwalForm" action="{{ route('addjadwal') }}" method="POST" class="form-validate is-alter">
                                    ...
                                    <div class="row gx-2">
                                        <div class="w-55">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" id="event-start-date" class="form-control date-picker" data-date-format="yyyy-mm-dd" required readonly>
                                            </div>
                                        </div>
                                        <div class="w-45">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" id="event-start-time" data-time-format="HH:mm:ss" class="form-control time-picker" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row gx-2">
                                        <div class="w-55">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" id="event-end-date" class="form-control date-picker" data-date-format="yyyy-mm-dd" readonly>
                                            </div>
                                        </div>
                                        <div class="w-45">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" id="event-end-time" data-time-format="HH:mm:ss" class="form-control time-picker" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
